...
public class RemoteController {
    ...
    @ResponseBody
    public OpenPage<HomeWork> getHomeworksByTeacher(@FastJson OpenPage<Information> openPage,@RequestParam String userId,HttpServletResponse response){
        Pageable pageAble = new PageRequest(openPage.getPageNo()-1, openPage.getPageSize());
        Page<HomeWork> page = homeWorkService.getHomeworksByTeacher(pageAble,userId);
        return PageConvert.convert(page);
    }
